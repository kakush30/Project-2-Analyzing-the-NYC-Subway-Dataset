from pandas import *
from ggplot1 import * #ggplot1 is customized package, use ggplot istead of ggplot1
...
def plot_weather_data(turnstile_weather):
   ...
   However, due to the limitation of our Amazon EC2 server, we are giving you a random
    ...
    norm = df.groupby(['rain'], as_index=False).aggregate(mean)
    print norm
    ...
    plot1 = ggplot(norm, aes(x='rain', y='ENTRIESn_hourly')) + geom_line() 
